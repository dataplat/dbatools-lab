...
Import-DbaSpConfigure @splatExportSpConf -WarningAction SilentlyContinue' -replace ([Regex]::Escape('Source      = "dbatoolslab"')),'Source      = "localhost,15992"' -replace ([Regex]::Escape('Destination = "dbatoolslab"')),'Destination      = "localhost,15993"' -replace ([Regex]::Escape('SharedPath  = "\\dbatoolslab\Backup"')),'SharedPath  = "/var/opt/mssql/backups/shared"' -replace ([Regex]::Escape('SharedPath    = "C:\dbatoolslab\Backup"')),'SharedPath  = "/var/opt/mssql/backups/shared"'
